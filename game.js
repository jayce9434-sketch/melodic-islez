...
function coinGardenMiss(btn){const g=arcadeGame;if(!g?.active||g.locked)return;g.locked=true;clearResourceTimers();g.misses++;g.combo=0;if(btn)btn.classList.add('wrong');sfx('bad');setTimeout(nextCoinGardenRound,220);}
