...
function freshState(){
  return {
    ...
    stats:{collectedCoins:0,breedCount:0,decorBought:0,songsPlayed:0,instantBreeds:0,notesSpent:0,starsSpent:0,gemsSpent:0,monstersBought:0,masteryBought:0,hatched:0,activePlayMs:0},
...
let state=load();
let audio=null,masterGain=null,musicBus=null,sfxBus=null,songTimer=null,songStep=0,selectedBreed=[],collectionVariant='All',lastActiveTick=now();
...
function demoState(){
  ...
  s.stats={...s.stats,collectedCoins:98000,breedCount:18,decorBought:9,songsPlayed:14,instantBreeds:3,notesSpent:740,starsSpent:11,gemsSpent:14,monstersBought:25,masteryBought:5,hatched:16,activePlayMs:76*60000};
